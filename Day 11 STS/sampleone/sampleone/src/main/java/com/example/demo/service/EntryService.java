...
public class EntryService {
	...
	public ResponseEntity<AuthenticationResponse> validateUser(AuthenticationRequest request) {
	...
	public ResponseEntity<AuthenticationResponse> CreateNewUser(RegisterRequest request) {
